<template>
    <div>
        <info-card :student="$page.props.student" class="mb-6"/>
...
export default {
    ...
    methods: {
        ...
        loadAnswer(id,field){
            for (var i = 0; i < this.$page.props.medical_record.length; i++) {
                if (this.$page.props.medical_record[i].quid === id) {
                    if(field == 'answer'){
                        return this.$page.props.medical_record[i].answer
                    }
                    if(field == 'sub_answer'){
                        if(!this.$page.props.medical_record[i].sub_answer === 'null'){
                            return this.$page.props.medical_record[i].sub_answer
                        }
                    }
                    if(field == 'date'){
                        return this.$page.props.medical_record[i].date
                    }
                    break;
                }
            }
